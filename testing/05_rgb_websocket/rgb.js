...
ledRed = new Gpio(589, {mode: Gpio.OUTPUT}), //use GPIO pin 18 as output for RED
ledGreen = new Gpio(594, {mode: Gpio.OUTPUT}), //use GPIO pin 23 as output for GREEN
ledBlue = new Gpio(595, {mode: Gpio.OUTPUT}), //use GPIO pin 24 as output for BLUE
